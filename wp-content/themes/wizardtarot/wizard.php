                    ...
                    <div class="row">
                      <div class="col-xs-12 top_imgs">
                        <div class="col-xs-1">
                          ...
                          <div class="tarot_zones well">
                            <div id="draggable21" class="itemlist_item item_list__mid draggable ui-draggable ui-draggable-handle elems_zone" style="left: 6px; top: 6px;">V2</div>
                            <div id="draggable31" class="itemlist_item item_list__mid draggable ui-draggable ui-draggable-handle elems_zone" style="left: 6px; top: 45px;">V3</div>
                            <div id="draggable41" class="itemlist_item item_list__mid draggable ui-draggable ui-draggable-handle elems_zone" style="left: 6px; top: 84px;">V4</div>
                            <div id="draggable51" class="itemlist_item item_list__mid draggable ui-draggable ui-draggable-handle elems_zone" style="left: 6px; top: 123px;">V5</div>
                        </div>
                        </div>
                        <div class="col-xs-10">
                          <div class="row">
                      ...
                      <div class="col-xs-5">
                        <div class="row">
                          <div class="first_cards cards_wrapper col-xs-12">
                            <div class="col-xs-2 elem_card_place elem_card_1 first_cards_1 fadeInLeft animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_2 first_cards_2 fadeInLeft animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_3 first_cards_3 fadeInLeft animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_4 first_cards_4 fadeInLeft animated hidden" style="margin-left: 10px"></div>
                          ...
                          <div class="second_cards cards_wrapper col-xs-12">
                            <div class="col-xs-2 elem_card_place elem_card_1 second_cards_5 fadeInRight animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_2 second_cards_4 fadeInRight animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_3 second_cards_3 fadeInRight animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_4 second_cards_2 fadeInRight animated hidden" style="margin-left: 10px"></div>
                            <div class="col-xs-2 elem_card_place second_cards_1 fadeInRight animated hidden" style="margin-left: 10px; background: #fff url(/wp-content/themes/wizardtarot/images/gallery/solar.png) 0 0/100% no-repeat;"></div>
                          </div>
                        </div>
                      </div>
                    </div>
