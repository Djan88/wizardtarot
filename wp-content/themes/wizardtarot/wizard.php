                  ...
                  <div class="container">
                    <div class="row">
                      <div class="btn-group btn-group-graf" data-toggle="buttons">
                        <label class="btn btn_sm btn_default btn__graf">
                            <input type="radio" name="grafOps" id="option1"> С графиком
                        </label>
                        <label class="btn btn_sm btn_default btn__nograf">
                      ...
                      <div class="col-xs-5">
                        <div class="row">
                          <div class="first_cards cards_wrapper col-xs-12">
                            <div class="col-xs-2 elem_card_place elem_card_1 first_cards_1 fadeInLeft animated hidden" style="margin-left: 5px; margin-right: 5px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_2 first_cards_2 fadeInLeft animated hidden" style="margin-left: 5px; margin-right: 5px"></div>
                            ...
                            <div class="col-xs-2 elem_card_place elem_card_4 first_cards_4 fadeInLeft animated hidden" style="margin-left: 5px; margin-right: 5px"></div>
                            <div class="col-xs-2 elem_card_place elem_card_5 first_cards_5 fadeInLeft animated hidden" style="margin-left: 5px; margin-right: 5px; background: #fff url(/wp-content/themes/wizardtarot/images/gallery/solar.png) 0 0/100% no-repeat;"></div>
                          </div>
