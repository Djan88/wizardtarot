...
Рекомендовано предварительное обучение пользователя формированию заявки на возврат системного ограничения через ключи архетипов!</p>
                        ...
                        <div class="elem-choice container hidden">
                          ...
                          <div class="bs-example elems_algoritm_block">
                           <p>
                            <div><b>Шаг 1</b></div>
                            <div>
                              Сделайте перцептивный дорсальный толчок у клиента в зоне V4 и определите по таблице первоэлементов время флюидического напряжения.
                            </div>
                           </p>
                           <p>
                            <div><b>Шаг 2</b></div>
                            <div>
                              Поместите в ладони клиента немного соли и дождитесь ощущения «заземления» клиента. Произведите перцептивный дорсальный толчок клиенту в зоне V4 и убедитесь, что флюидическое время в таблице соответствует первоэлементу «Земля».
                            </div>
                           </p>
                           <p>
                            <div><b>Шаг 3</b></div>
                            <div>
                              Уберите соль из ладоней клиента, после паузы не менее 10 секунд вновь произведите перцептивный дорсальный толчок в зоне V4. Определите время флюидического напряжения по таблице первоэлементов. Это и будет соответствовать  конституциональному первоэлементному дисбалаянсу клиента.
                            </div>
                           </p>
                           <p>
                            <div><b>Шаг 4</b></div>
                            <div>
                              Выберите протокол Tarotmachine в соответствии с найденным конституциональным первоэлементом у клиента!
                            </div>
                           </p>
                          </div>
                            ...
                            <div class="row elems">
                              <div class="col-md-3 elem_wrap">
                                ...
                                <div class="elem_circle">
                                  ...
                                  <div class="number number_three">3</div>
                                  <div class="number number_four">4</div>
                                  <div class="number number_five">5</div>
                                  <div class="number number_six">6</div>
                                  <div class="number number_seven">7</div>
                                  <div class="number number_eight">8</div>
                                  <div class="number number_nine">9</div>
                                ...
                                <div class="hexagon hexagon2 gallery-item">
                                  <div class="hexagon-in1">
                                    <div class="hexagon-in2" style="background-image: url('http://wizardtarot.ru/wp-content/themes/wizardtarot/images/gallery/15-Major-Devil-min.png');">
                                      <div class="overlay">
                                        <a href="http://wizardtarot.ru/wp-content/themes/wizardtarot/images/gallery/15-Major-Devil-min.png" data-rel="lightbox" class="fa fa-expand"></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
