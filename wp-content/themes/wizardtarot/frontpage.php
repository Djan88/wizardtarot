                            ...
                            <table class="table table-bordered table-hover">
                              <tbody>
                                <tr>
                                  ...
                                  <td class="elemnts_td_btn"><button type="button" class="btn btn-default btn-lg elem-choice-item btn-success" data-elem="air">Воздух</button></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td class="elemnts_td_btn"><button type="button" class="btn btn-default btn-lg elem-choice-item btn-success" data-elem="fire">Огонь</button></td>
                                </tr>
                                <tr>
                                  ...
                                  <td class="elemnts_td_btn"><button type="button" class="btn btn-default btn-lg elem-choice-item btn-success" data-elem="water">Вода</button></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
